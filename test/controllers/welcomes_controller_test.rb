...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { index: @welcome.index, personal: @welcome.personal, projects: @welcome.projects, resume: @welcome.resume }
    end
  ...
  test "should update welcome" do
    patch :update, id: @welcome, welcome: { index: @welcome.index, personal: @welcome.personal, projects: @welcome.projects, resume: @welcome.resume }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
